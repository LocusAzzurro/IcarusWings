...
public class ModRecipesProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                tag(Tags.Items.FEATHERS), Ingredient.of(Items.GOLD_INGOT), RecipeCategory.MISC, ItemRegistry.GOLDEN_FEATHER.get())
        ...
        shapeless(RecipeCategory.MISC, ItemRegistry.FEATHER_BUNCH.get())
                .requires(tag(Tags.Items.FEATHERS), 4).requires(tag(Tags.Items.STRINGS))
                .unlockedBy(getHasName(Items.FEATHER), has(Tags.Items.FEATHERS)).save(recipeOutput);
        shapeless(RecipeCategory.MISC, ItemRegistry.COLORED_FEATHER_BUNCH.get())
                .requires(tag(ModTags.COLORED_FEATHERS), 4).requires(tag(ModTags.CROP_STRINGS))
                .unlockedBy(getHasName(Items.FEATHER), has(ModTags.COLORED_FEATHERS)).save(recipeOutput);
        shapeless(RecipeCategory.MISC, ItemRegistry.GOLDEN_FEATHER_BUNCH.get())
        ...
        shapeless(RecipeCategory.MISC, ItemRegistry.HERB_BUNCH.get())
                .requires(tag(ModTags.HERBS), 4).requires(tag(ModTags.CROP_STRINGS))
                .unlockedBy(getHasName(Items.STRING), has(ModTags.HERBS)).save(recipeOutput);

        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ItemRegistry.STEEL_MIXTURE.get()), RecipeCategory.MISC, CookingBookCategory.MISC, ItemRegistry.STEEL_INGOT.get(), 0.1f, 400)
                .unlockedBy(getHasName(ItemRegistry.STEEL_MIXTURE.get()), has(ItemRegistry.STEEL_MIXTURE.get())).save(recipeOutput);
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ItemRegistry.MAGMA_MIXTURE.get()), RecipeCategory.MISC, CookingBookCategory.MISC, ItemRegistry.MAGMA_INGOT.get(), 0.2f, 400)
                .unlockedBy(getHasName(ItemRegistry.STEEL_MIXTURE.get()), has(ItemRegistry.STEEL_MIXTURE.get())).save(recipeOutput);
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ItemRegistry.PURPUR_MIXTURE.get()), RecipeCategory.MISC, CookingBookCategory.MISC, ItemRegistry.PURPUR_INGOT.get(), 0.2f, 400)
                .unlockedBy(getHasName(ItemRegistry.STEEL_MIXTURE.get()), has(ItemRegistry.STEEL_MIXTURE.get())).save(recipeOutput);

        shapeless(RecipeCategory.MISC, ItemRegistry.STEEL_MIXTURE.get())
        ...
        shapeless(RecipeCategory.MISC, ItemRegistry.MAGMA_MIXTURE.get())
        ...
        shapeless(RecipeCategory.MISC, ItemRegistry.PURPUR_MIXTURE.get())
        ...
        essenceConverting(ItemRegistry.ZEPHIR_AIR_JAR.get(), ItemRegistry.ZEPHIR_ESSENCE.get());
        essenceConverting(ItemRegistry.NETHER_AIR_JAR.get(), ItemRegistry.NETHER_ESSENCE.get());
        essenceConverting(ItemRegistry.VOID_AIR_JAR.get(), ItemRegistry.VOID_ESSENCE.get());

        shaped(RecipeCategory.TOOLS, ItemRegistry.GOLD_UPGRADE_SMITHING_TEMPLATE.get())
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(Items.NETHERITE_INGOT), RecipeCategory.MISC, CookingBookCategory.MISC, ItemRegistry.REFORGED_NETHERITE_INGOT.get(), 0.5f, 400)
                .unlockedBy(getHasName(Items.NETHERITE_INGOT), has(Items.NETHERITE_INGOT)).save(recipeOutput);
        shapeless(RecipeCategory.MISC, ItemRegistry.SYNAPSE_ALLOY_INGOT.get())
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.HONEYCOMB), RecipeCategory.FOOD, CookingBookCategory.FOOD, ItemRegistry.BEESWAX.get(), 0.1f, 400)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(Items.HONEYCOMB), RecipeCategory.MISC, CookingBookCategory.MISC, ItemRegistry.BEESWAX.get(), 0.1f, 200)
        ...
        twoByTwoPacker( RecipeCategory.BUILDING_BLOCKS, ItemRegistry.BEESWAX_BLOCK.get(), ItemRegistry.BEESWAX.get());
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ItemRegistry.BEESWAX_BLOCK.get()), RecipeCategory.MISC, CookingBookCategory.MISC, ItemRegistry.REFINED_BEESWAX_BAR.get(), 0.1f, 200)
                .unlockedBy(getHasName(ItemRegistry.BEESWAX_BLOCK.get()), has(ItemRegistry.BEESWAX_BLOCK.get())).save(recipeOutput);
        shaped(RecipeCategory.BUILDING_BLOCKS, ItemRegistry.GLISTERING_REFINED_BEESWAX_BAR.get())
        ...
        twoByTwoPacker( RecipeCategory.BUILDING_BLOCKS, ItemRegistry.REFINED_BEESWAX_BLOCK.get(), ItemRegistry.REFINED_BEESWAX_BAR.get());
        slabRecipes(ItemRegistry.REFINED_BEESWAX_BLOCK.get(), RecipeCategory.BUILDING_BLOCKS, ItemRegistry.REFINED_BEESWAX_SLAB.get());
        shaped(RecipeCategory.BUILDING_BLOCKS, ItemRegistry.REFINED_BEESWAX_PILLAR.get(), 2)
        ...
        shaped(RecipeCategory.BUILDING_BLOCKS, ItemRegistry.REFINED_BEESWAX_STAIRS.get(), 3)
                .define('#', ItemRegistry.REFINED_BEESWAX_BLOCK.get()).pattern("# ").pattern("##")
                .unlockedBy(getHasName(ItemRegistry.REFINED_BEESWAX_BLOCK.get()), has(ItemRegistry.REFINED_BEESWAX_BLOCK.get())).save(recipeOutput);
        chiseled( RecipeCategory.BUILDING_BLOCKS, ItemRegistry.CHISELED_REFINED_BEESWAX_BLOCK.get(), ItemRegistry.REFINED_BEESWAX_SLAB.get());
        polished( RecipeCategory.BUILDING_BLOCKS, ItemRegistry.SMOOTH_REFINED_BEESWAX_BLOCK.get(), ItemRegistry.REFINED_BEESWAX_BLOCK.get());
        refinedBeeswaxRecycle(ItemRegistry.REFINED_BEESWAX_BLOCK.get(), 4);
        refinedBeeswaxRecycle(ItemRegistry.REFINED_BEESWAX_SLAB.get(), 2);
        refinedBeeswaxRecycle(ItemRegistry.REFINED_BEESWAX_PILLAR.get(), 4);
        refinedBeeswaxRecycle(ItemRegistry.REFINED_BEESWAX_STAIRS.get(), 3);
        refinedBeeswaxRecycle(ItemRegistry.CHISELED_REFINED_BEESWAX_BLOCK.get(), 4);
        refinedBeeswaxRecycle(ItemRegistry.SMOOTH_REFINED_BEESWAX_BLOCK.get(), 4);

        shaped(RecipeCategory.BUILDING_BLOCKS, ItemRegistry.GOLDEN_WOOL_BLOCK.get())
        ...
        carpet( ItemRegistry.GOLDEN_WOOL_CARPET.get(), ItemRegistry.GOLDEN_WOOL_BLOCK.get());

        shaped(RecipeCategory.FOOD, ItemRegistry.HONEY_CAKE.get())
        ...
        shaped(RecipeCategory.BREWING, ItemRegistry.MEAD_POT.get())
        ...
        shaped(RecipeCategory.DECORATIONS, ItemRegistry.AMPHORA.get())
                .define('T', Items.TERRACOTTA).pattern("T T").pattern("T T").pattern(" T ")
                .unlockedBy(getHasName(Items.TERRACOTTA), has(Items.TERRACOTTA)).save(recipeOutput);

        shaped(RecipeCategory.BREWING, ItemRegistry.GLASS_JAR.get(), 2)
        ...
        meadInfusion(ItemRegistry.ZEPHIR_ESSENCE.get(), ItemRegistry.ZEPHIR_INFUSED_MEAD.get());
        meadInfusion(ItemRegistry.NETHER_ESSENCE.get(), ItemRegistry.NETHER_INFUSED_MEAD.get());
        meadInfusion(ItemRegistry.VOID_ESSENCE.get(), ItemRegistry.VOID_INFUSED_MEAD.get());
        shapeless(RecipeCategory.BREWING, ItemRegistry.GOLDEN_APPLE_INFUSED_MEAD.get())
        ...
        shapeless(RecipeCategory.BREWING, ItemRegistry.GOLDEN_APPLE_GROWTH_INFUSED_MEAD.get())
                .requires(ItemRegistry.GOLDEN_APPLE_INFUSED_MEAD.get()).requires(tag(ModTags.CROP_GRAINS), 4)
        ...
        shapeless(RecipeCategory.BREWING, ItemRegistry.HERBS_INFUSED_MEAD.get())
        ...
        shapeless(RecipeCategory.TOOLS, ItemRegistry.MAGICAL_ANEMONE.get())
        ...
        shaped(RecipeCategory.TOOLS, ItemRegistry.WIND_WAND.get())
        ...
        stoneCutter(RecipeCategory.MISC, ItemRegistry.WHEAT_GRAINS.get(), Items.WHEAT, 2);
        stoneCutter(RecipeCategory.MISC, ItemRegistry.WHEAT_STRING.get(), Items.WHEAT, 2);
        stoneCutter(RecipeCategory.MISC, ItemRegistry.FLAX_SEEDS.get(), ItemRegistry.FLAX.get(), 2);
        stoneCutter(RecipeCategory.MISC, ItemRegistry.LINEN_STRING.get(), ItemRegistry.FLAX.get(), 2);
        SmithingTransformRecipeBuilder.smithing(
                        Ingredient.of(ItemRegistry.GOLD_UPGRADE_SMITHING_TEMPLATE.get()),
                        tag(Tags.Items.STRINGS), Ingredient.of(Items.GOLD_INGOT), RecipeCategory.MISC, ItemRegistry.GOLDEN_STRING.get())
        ...
        threeByThreePacker( RecipeCategory.MISC, ItemRegistry.LINEN.get(), ItemRegistry.LINEN_STRING.get());
        shapeless(RecipeCategory.FOOD, ItemRegistry.GRAINS_MEAL.get())
                .requires(Items.BOWL).requires(tag(ModTags.CROP_GRAINS), 2)
                .unlockedBy("has_grains", has(ModTags.CROP_GRAINS)).save(recipeOutput);

        shaped(RecipeCategory.COMBAT, ItemRegistry.HERBAL_CROWN.get())
                .define('H', ModTags.HERBS).pattern("HHH").pattern("H H")
                .unlockedBy("has_herb", has(ModTags.HERBS)).save(recipeOutput);
        shaped(RecipeCategory.COMBAT, ItemRegistry.FEATHER_HELMET.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.GOLDEN_FEATHER_HELMET.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.LINEN_CLOAK.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.LINEN_UNDERGARMENT.get())
                .define('L', ItemRegistry.LINEN.get()).pattern("LLL").pattern("L L").pattern("L L")
                .unlockedBy(getHasName(ItemRegistry.LINEN.get()), has(ItemRegistry.LINEN.get())).save(recipeOutput);
        shaped(RecipeCategory.COMBAT, ItemRegistry.GOLDEN_FLEECE_MANTLE.get())
                .define('F', ItemRegistry.GOLDEN_FLEECE.get()).define('S', ItemRegistry.GOLDEN_STRING.get())
                .pattern("F F").pattern("SFS")
                .unlockedBy(getHasName(ItemRegistry.GOLDEN_FLEECE.get()), has(ItemRegistry.GOLDEN_FLEECE.get())).save(recipeOutput);
        shaped(RecipeCategory.COMBAT, ItemRegistry.BEESWAX_BOOTS.get())
                .define('W', ItemRegistry.REFINED_BEESWAX_BAR.get()).pattern("W W").pattern("W W")
                .unlockedBy(getHasName(ItemRegistry.REFINED_BEESWAX_BAR.get()), has(ItemRegistry.REFINED_BEESWAX_BAR.get())).save(recipeOutput);

        wings(ItemRegistry.FEATHER_WINGS.get(), ItemRegistry.FEATHER_BUNCH.get(), ItemRegistry.BEESWAX.get());
        wings(ItemRegistry.COLORED_FEATHER_WINGS.get(), ItemRegistry.COLORED_FEATHER_BUNCH.get(), ItemRegistry.REFINED_BEESWAX_BAR.get());
        wings(ItemRegistry.GOLDEN_FEATHER_WINGS.get(), ItemRegistry.GOLDEN_FEATHER_BUNCH.get(), ItemRegistry.GLISTERING_REFINED_BEESWAX_BAR.get());
        wings(ItemRegistry.PAPER_WINGS.get(), Items.PAPER, Items.STICK);

        shapeless(RecipeCategory.MISC, ItemRegistry.MAGIC_MEMBRANE.get())
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.PHILOSOPHER_STONE.get())
        ...
        shapeless(RecipeCategory.TOOLS, ItemRegistry.MAGIC_WINGS.get())
        ...
        shaped(RecipeCategory.TOOLS, ItemRegistry.FLANDRE_MAGIC_WINGS.get())
        ...
        shapeless(RecipeCategory.TOOLS, ItemRegistry.DAEDALUS_MANUSCRIPT.get())
                .requires(Items.PAPER).requires(Tags.Items.FEATHERS).requires(Items.INK_SAC)
                .unlockedBy(getHasName(Items.FEATHER), has(Tags.Items.FEATHERS)).save(recipeOutput);
        shapeless(RecipeCategory.TOOLS, ItemRegistry.DAEDALUS_DECRYPTOR.get())
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.RESTORED_FALLEN_RELIC_CORE.get())
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.RESTORED_FALLEN_RELIC_INTERFACE.get())
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.RESTORED_FALLEN_RELIC_OFFENSIVE.get())
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.RESTORED_FALLEN_RELIC_DEFENSIVE.get())
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.RESTORED_FALLEN_RELIC_PROPULSION.get())
        ...
        shaped(RecipeCategory.MISC, ItemRegistry.UPGRADED_FALLEN_RELIC_CORE.get())
        ...
        shapeless(RecipeCategory.TOOLS, ItemRegistry.SYNAPSE_REPAIR_KIT.get())
                .requires(orIngredient(ModTags.FALLEN_RELICS, ItemRegistry.REFORGED_NETHERITE_INGOT.get()))
                .requires(tag(ModTags.WORLD_ESSENCES)).requires(ItemRegistry.DAEDALUS_DECRYPTOR.get())
                .unlockedBy("has_synapse_armor", has(ModTags.SYNAPSE_ARMOR)).save(recipeOutput);
        shaped(RecipeCategory.TOOLS, ItemRegistry.SYNAPSE_WINGS_RECHARGER.get())
        ...
        shaped(RecipeCategory.TOOLS, ItemRegistry.QUANTUM_FUEL.get())
                .define('S', orIngredient(ModTags.C_STEEL_INGOT, ItemRegistry.STEEL_INGOT.get()))
                .define('N', Items.NETHER_STAR)
                .pattern(" S ").pattern("SNS").pattern(" S ")
                .unlockedBy(getHasName(Items.NETHER_STAR), has(Items.NETHER_STAR)).save(recipeOutput);

        shaped(RecipeCategory.COMBAT, ItemRegistry.SYNAPSE_HELMET.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.SYNAPSE_CHESTPLATE.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.SYNAPSE_LEGGINGS.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.SYNAPSE_BOOTS.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.SYNAPSE_ALLOY_SWORD.get())
        ...
        shaped(RecipeCategory.TOOLS, ItemRegistry.STEEL_PICKAXE.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.WOODEN_SPEAR.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.STONE_SPEAR.get())
        ...
        spear(Items.IRON_INGOT, ItemRegistry.IRON_SPEAR.get());
        shaped(RecipeCategory.COMBAT, ItemRegistry.STEEL_SPEAR.get())
                .define('P', ItemTags.LOGS).define('T', orIngredient(ModTags.C_STEEL_INGOT, ItemRegistry.STEEL_INGOT.get()))
                .pattern("  T").pattern(" P ").pattern("P  ")
                .unlockedBy("has_steel", has(ModTags.C_STEEL_INGOT)).save(recipeOutput);
        spear(Items.GOLD_INGOT, ItemRegistry.GOLDEN_SPEAR.get());
        spear(Items.DIAMOND, ItemRegistry.DIAMOND_SPEAR.get());
        spear(Items.NETHERITE_INGOT, ItemRegistry.NETHERITE_SPEAR.get());
        spear(ItemRegistry.SYNAPSE_ALLOY_INGOT.get(), ItemRegistry.SYNAPSE_ALLOY_SPEAR.get());
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.ARTEMIS_LAUNCHER.get())
                ...
                .save(recipeOutput);
        shaped(RecipeCategory.COMBAT, ItemRegistry.ARTEMIS_MISSILE.get(), 4)
                ...
                .save(recipeOutput);
        shaped(RecipeCategory.COMBAT, ItemRegistry.TIME_RIFT_GENERATOR.get())
        ...
        shaped(RecipeCategory.COMBAT, ItemRegistry.TIME_RIFT_CHARGE.get(), 4)
                ...
                .save(recipeOutput);
        shaped(RecipeCategory.COMBAT, ItemRegistry.DEMETER.get())
                ...
                .unlockedBy(getHasName(ItemRegistry.TIME_RIFT_GENERATOR.get()), has(ItemRegistry.TIME_RIFT_GENERATOR.get()))
                .save(recipeOutput);
        shaped(RecipeCategory.COMBAT, ItemRegistry.DEMETER_CHARGE.get(), 2)
        ...
        shaped(RecipeCategory.TOOLS, ItemRegistry.TRANSPORT_CARD_BASE.get(), 16)
                ...
                .save(recipeOutput);
        shaped(RecipeCategory.TOOLS, ItemRegistry.TRANSPORT_CARD_ARTEMIS_HOMING.get(), 4)
                ...
                .save(recipeOutput);
        shaped(RecipeCategory.TOOLS, ItemRegistry.TRANSPORT_CARD_ARTEMIS_SCATTER.get(), 4)
                .define('C', ItemRegistry.TRANSPORT_CARD_BASE.get()).define('A', ItemRegistry.ARTEMIS_MISSILE.get())
                .define('T', Items.REDSTONE_TORCH).define('M', Items.REPEATER)
                .pattern("AMA").pattern("ACA").pattern("ATA")
                .unlockedBy(getHasName(ItemRegistry.TRANSPORT_CARD_BASE.get()), has(ItemRegistry.TRANSPORT_CARD_BASE.get()))
                .save(recipeOutput);
        shaped(RecipeCategory.TOOLS, ItemRegistry.TRANSPORT_CARD_CHRONO_EXPLOSION.get(), 2)
                ...
                .unlockedBy(getHasName(ItemRegistry.TRANSPORT_CARD_BASE.get()), has(ItemRegistry.TRANSPORT_CARD_BASE.get()))
                .save(recipeOutput);
        shaped(RecipeCategory.TOOLS, ItemRegistry.TRANSPORT_CARD_CHRONO_TELEPORT.get(), 4)
                .define('C', ItemRegistry.TRANSPORT_CARD_BASE.get()).define('E', Items.ENDER_PEARL)
                .define('Q', ItemRegistry.QUANTUM_FUEL.get())
                .pattern("EQE").pattern("ECE").pattern("EQE")
                .unlockedBy(getHasName(ItemRegistry.TRANSPORT_CARD_BASE.get()), has(ItemRegistry.TRANSPORT_CARD_BASE.get()))
                .save(recipeOutput);
        shaped(RecipeCategory.TOOLS, ItemRegistry.TRANSPORT_CARD_MASKING_FIELD.get(), 1)
                ...
                .unlockedBy(getHasName(ItemRegistry.TRANSPORT_CARD_BASE.get()), has(ItemRegistry.TRANSPORT_CARD_BASE.get()))
                .save(recipeOutput);
        shaped(RecipeCategory.TOOLS, ItemRegistry.TRANSPORT_CARD_INTERDICTION_FIELD.get(), 1)
                .define('C', ItemRegistry.TRANSPORT_CARD_BASE.get())
                .define('W', Items.COBWEB).define('R', Items.COMPARATOR)
                .pattern("WRW").pattern("WCW").pattern("WRW")
                .unlockedBy(getHasName(ItemRegistry.TRANSPORT_CARD_BASE.get()), has(ItemRegistry.TRANSPORT_CARD_BASE.get()))
                .save(recipeOutput);
        shaped(RecipeCategory.TOOLS, ItemRegistry.TRANSPORT_CARD_TREASURE.get(), 1)
                .define('C', ItemRegistry.TRANSPORT_CARD_BASE.get())
                .define('G', Items.GOLD_NUGGET).define('X', Items.CHEST)
                .pattern(" X ").pattern("GCG").pattern(" X ")
                .unlockedBy(getHasName(ItemRegistry.TRANSPORT_CARD_BASE.get()), has(ItemRegistry.TRANSPORT_CARD_BASE.get()))
                .save(recipeOutput);
        shaped(RecipeCategory.TOOLS, new ItemStackTemplate(
                ItemRegistry.TRANSPORT_CARD_TREASURE.get(), 1, DataComponentPatch.builder().set(
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.MUSIC_DISC_13), RecipeCategory.MISC, CookingBookCategory.MISC, ItemRegistry.DISC_FALLEN_DOWN.get(), 0.1f, 200)
                .unlockedBy(getHasName(Items.MUSIC_DISC_13), has(Items.MUSIC_DISC_13)).save(recipeOutput);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.MUSIC_DISC_CAT), RecipeCategory.MISC, CookingBookCategory.MISC, ItemRegistry.DISC_RING_MY_BELL.get(), 0.1f, 200)
                .unlockedBy(getHasName(Items.MUSIC_DISC_CAT), has(Items.MUSIC_DISC_CAT)).save(recipeOutput);

        shapeless(RecipeCategory.DECORATIONS, ItemRegistry.MELON.get())
    ...
    private void essenceConverting(ItemLike air, ItemLike essence){
        shaped(RecipeCategory.MISC, essence).define('A', air).define('S', ItemRegistry.PHILOSOPHER_STONE.get())
                .pattern("AAA").pattern("ASA").pattern("AAA")
                .unlockedBy(getHasName(air), has(air)).save(this.output);
        shaped(RecipeCategory.MISC, air, 4).define('E', essence).define('B', ItemRegistry.GLASS_JAR.get())
                .pattern(" B ").pattern("BEB").pattern(" B ")
                .unlockedBy(getHasName(essence), has(essence)).save(this.output);
    }

    private void slabRecipes(ItemLike block, RecipeCategory recipeCategory, ItemLike slab){
        slabBuilder(recipeCategory, slab, Ingredient.of(block)).unlockedBy(getHasName(block), has(block)).save(this.output);
        stoneCutter(recipeCategory, slab, block, 2);
    }

    private void refinedBeeswaxRecycle(ItemLike block, int bars){
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(block), RecipeCategory.MISC, ItemRegistry.REFINED_BEESWAX_BAR.get(), bars)
                .unlockedBy(getHasName(block), has(block)).save(this.output, wrapModNamespace("refined_beeswax_bar_recycle_from_" + getItemName(block)));
    }

    private void meadInfusion(ItemLike essence, ItemLike infused){
        shapeless(RecipeCategory.BREWING, infused).requires(ItemRegistry.MEAD.get()).requires(essence, 2)
                .unlockedBy(getHasName(essence), has(essence)).save(this.output);
    }

    private void wings(ItemLike result, ItemLike wing, ItemLike bind){
        shaped(RecipeCategory.TOOLS, result)
                ...
                .unlockedBy(getHasName(wing), has(wing)).save(this.output);
    }

    private void synapseWings(ItemLike result, ItemLike core, ItemLike l1, ItemLike r1, ItemLike l2, ItemLike r2){
        shaped(RecipeCategory.COMBAT, result)
                ...
                .unlockedBy(getHasName(core), has(core)).save(this.output);
    }

    private void stoneCutter(RecipeCategory category, ItemLike result, ItemLike material, int count){
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(material), category, result, count).unlockedBy(getHasName(material), has(material)).save(this.output, wrapModNamespace(getItemName(result) + "_stonecutting"));
    }

    private void spear(ItemLike material, ItemLike spear){
        shaped(RecipeCategory.COMBAT, spear)
                .define('P', ItemTags.LOGS).define('T', material)
                .pattern("  T").pattern(" P ").pattern("P  ")
                .unlockedBy(getHasName(material), has(material)).save(this.output);
    }

    private Ingredient orIngredient(net.minecraft.tags.TagKey<Item> tag, Item item) {
        return CompoundIngredient.of(this.tag(tag), Ingredient.of(item));
    }

    private static String wrapModNamespace(String name){
        return Identifier.fromNamespaceAndPath(IcarusWings.MOD_ID, name).toString();
    }
