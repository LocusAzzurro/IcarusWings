...
public class EnchantmentRegistry {
	...
	public static final net.minecraftforge.registries.RegistryObject<Enchantment> pyrotechnicAffinity = ENCHANTMENTS.register("pyrotechnic_affinity", EnchantmentPyrotechnicAffinity::new);
	public static final net.minecraftforge.registries.RegistryObject<Enchantment> blessingOfTheSky = ENCHANTMENTS.register("blessing_of_the_sky", EnchantmentBlessingOfTheSky::new);
}
