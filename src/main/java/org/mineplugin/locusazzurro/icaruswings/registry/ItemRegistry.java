...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> flaxCrop = ITEMS.register("flax",
            () -> new BlockItem(BlockRegistry.flaxCrop.get(), new Item.Properties().tab(ModGroup.itemGroup)));
